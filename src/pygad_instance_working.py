...
def fitness_function(solution, solution_idx):
    ...
    # print("Goal position:2", GOAL_1, ", ", GOAL_2) print("Agent position before rule:", ag_pos_before_rule_1, ",",
    # ag_pos_before_rule_2, "; move:", movement_dictionary[solution[1]]) print("Agent position after rule:",
    # ag_pos_after_rule_1, ",",  ag_pos_after_rule_2)
...
def main():
    ...
    for x in range(1000):
        ...
        print("Position: (", math.floor(list_of_rules[x][0] / 15), ", ", list_of_rules[x][0] % 15, ") =",
              list_of_rules[x][0])
    ...
    while agent_position_1 != GOAL_1 or agent_position_2 != GOAL_2:
        ...
        if environment[agent_position_1][agent_position_2] == 42:
            ...
            print("We use the random movement", movement_dictionary[mov], " and we move to", agent_position_1, ",",
                  agent_position_2)
